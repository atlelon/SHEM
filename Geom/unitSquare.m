function [x,y]=unitSquare(bs,s)
%SGEOM	Gives geometry data for the sgeom PDE model.
%
%   NBS=SGEOM gives the number of boundary segments
%
%   D=SGEOM(BS) gives a matrix with one column for each boundary segment
%   specified in BS.
...
%
%   [X,Y]=SGEOM(BS,S) gives coordinates of boundary points. BS specifies the
